...
public class Board {
  ...
  public boolean freshFigureMustStopLeft() {
    return FreshStopSides.mustStopL(true, stopBlocks, uniqueY0, uniqueY1, uniqueY2, uniqueY3,
        blackWhite, freshFigure, x, y);
  }

  public boolean freshFigureMustStopRight() {
    return FreshStopSides.mustStopL(false, stopBlocks, uniqueY0, uniqueY1, uniqueY2, uniqueY3,
        blackWhite, freshFigure, x, y);
  }

  public boolean freshFigureMustStopDown() {
    return FreshStopDown.mustStopDown(stopBlocks, uniqueY0, uniqueY1, uniqueY2, uniqueY3,
        blackWhite, freshFigure, x, y);
  }
